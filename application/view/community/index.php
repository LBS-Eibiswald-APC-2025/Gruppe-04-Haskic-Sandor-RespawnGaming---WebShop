...
<script src="/public/js/community/community.js" defer></script>
    ...
    <div class="container mt-5">
        ...
        <div class="forum-categories mb-4">
            <ul class="nav nav-tabs justify-content-center">
                ...
                <li class="nav-item"><a class="nav-link" data-category="support" href="#">Support</a></li>
            </ul>
        </div>
                    ...
                    <?php foreach ($threads as $thread): ?>
                        <div class="thread-item" data-category="<?php echo htmlspecialchars($thread->category); ?>">
                            <div class="thread-title">
                                <a href="<?php echo Config::get('URL'); ?>community/thread/<?php echo $thread->id; ?>">
                            ...
                            <div class="thread-meta">
                                ...
                                <span class="last-reply">Letzte Antwort: <?php echo htmlspecialchars($thread->last_reply); ?></span>
                            </div>
...
<div class="modal" id="newThreadModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="newThreadForm" method="post" action="<?php echo Config::get('URL'); ?>community/createNewThread">
