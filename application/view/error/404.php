...
<head>
    ...
    <style>
        ...
        * {margin: 0; padding: 0; box-sizing: border-box;
        ...
        body {background: #1B2838; display: flex; align-items: center; justify-content: center; min-height: 80vh; font-family: Arial, sans-serif; color: #fff; text-align: center}
        ...
        p {font-size: 1.2rem; color: #F15147; font-family: 'Playstation', 'Segoe UI', Tahoma, sans-serif !important}
    </style>
</head>
<body>
<div class="container">
